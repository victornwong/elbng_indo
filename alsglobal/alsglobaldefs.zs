...
MYSOFTDATABASESERVER = "192.168.0.5:1433";
MYSOFTDATABASENAME = "indon_base";
DOCUMENTSTORAGE_DATABASE = "indon_document";
...
JOBFOLDERS_PREFIX = "ALSI";
JB_JOBFOLDERS_PREFIX = "ALSI";
KK_JOBFOLDERS_PREFIX = "ALSI";

// ENDOF tx to globaldefs

// 16/06/2014: prefixes for new modules
COLDCALL_PREFIX = "CLD";
