...
//---- 04/07/2014: BIRT templates active

//BIRT_COAPOT_WITHLOGO = "coatemplates/coapot_v6.rptdesign";
//BIRT_COAPOT_WITHOUTLOGO = "coatemplates/coapot_v6_nologo.rptdesign";

BIRT_COAPOT_WITHLOGO = "coatemplates/coapot_v7.rptdesign";
BIRT_COAPOT_WITHOUTLOGO = "coatemplates/coapot_v7_nologo.rptdesign";

BIRT_COAPOT_LOGO_LILREF = "coapotv6_lilmethods.rptdesign"; // 27/05/2011: put back the prev template with little method-refs
BIRT_COAPOT_NOLOGO_LILREF = "coapotv6nologo_lilmethods.rptdesign"; // used in printPotraidCOA_lilref.zul

COAPOT_WITHLOGO_WITHSPECS = "coapot_v6_withspecs.rptdesign"; // used in print_potraitsingle_coa_withspecs.zul
